...
const ImageOfTheDay: React.FC<ImageOfTheDayProps> = ({date}) => {
     ...
     const procDate = date.toLocaleDateString("fr-ca", {year: "numeric",
     month: "2-digit",
     day: "2-digit",
    ...
    return (<ImageView title={imageResponse.title} imageURL={imageResponse.url} imageURLHD={imageResponse.hdurl} explanation={imageResponse.explanation} date={imageResponse.date} expand={true} contentType={imageResponse.media_type} >
    </ImageView>);
    }else{
        return (
